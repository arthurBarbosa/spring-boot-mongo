...
import com.abcode.mongo.models.embedded.Author;
import com.abcode.mongo.models.embedded.Comment;
...
public class TestConfig {
    ...
    public void init() {
        ...
        Post post1 = new Post(null, Instant.parse("2021-03-25T11:15:01Z"), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", new Author(maria));
